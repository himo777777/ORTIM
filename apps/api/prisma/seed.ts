...
function getQuizQuestions() {
  return [
    ...
    },
    {
      ...
      chapterNumber: 13,
      bloomLevel: 'KNOWLEDGE',
      question: 'Vad är "lethal triad" vid trauma?',
      options: [
        { text: 'Hypotermi, acidos, koagulopati', correct: true },
        { text: 'Hypertension, takykardi, feber', correct: false },
        { text: 'Hypoglykemi, hyperkalemi, anemi', correct: false },
        { text: 'Andningssvikt, njursvikt, leversvikt', correct: false },
      ],
      explanation: 'Lethal triad (dödens triad) är hypotermi, metabol acidos och koagulopati - en ond cirkel vid svårt trauma.',
      reference: 'B-ORTIM Kursbok, Kapitel 13; ATLS 10th ed',
    },
    {
      code: '13.7',
      chapterNumber: 13,
      bloomLevel: 'COMPREHENSION',
      question: 'Varför förvärrar hypotermi koagulopati?',
      options: [
        { text: 'Koagulationsenzymer fungerar sämre vid låg temperatur', correct: true },
        { text: 'Blodkärlen vidgas', correct: false },
        { text: 'Blodtrycket stiger', correct: false },
        { text: 'Hypotermi påverkar ej koagulation', correct: false },
      ],
      explanation: 'Koagulationskaskaden är temperaturberoende - vid <35°C minskar enzymaktiviteten signifikant.',
      reference: 'B-ORTIM Kursbok, Kapitel 13',
    },
    {
      code: '13.8',
      ...
      question: 'Vad innebär ETC (Early Total Care)?',
      options: [
        { text: 'Definitiv frakturfixation tidigt hos stabil patient', correct: true },
        { text: 'Extern fixation alltid', correct: false },
        { text: 'Vänta med all kirurgi', correct: false },
        { text: 'Endast gipsbehandling', correct: false },
      ],
      explanation: 'ETC innebär tidig definitiv frakturbehandling (märgspik, platta) hos fysiologiskt stabila patienter.',
      reference: 'B-ORTIM Kursbok, Kapitel 13; Bone LB J Bone Joint Surg 1989',
    },
    {
      code: '13.9',
      chapterNumber: 13,
      bloomLevel: 'APPLICATION',
      question: 'Vilka parametrar indikerar DCO framför ETC?',
      options: [
        { text: 'pH <7.25, temp <35°C, laktat >4, koagulopati, instabil hemodynamik', correct: true },
        { text: 'Endast ålder >60', correct: false },
        { text: 'Alla öppna frakturer', correct: false },
        { text: 'Puls >80', correct: false },
      ],
      explanation: 'DCO-indikatorer: metabol acidos, hypotermi, förhöjt laktat, koagulopati, behov av vasopressor.',
      reference: 'B-ORTIM Kursbok, Kapitel 13; Pape HC J Trauma 2007',
    },
    {
      code: '13.10',
      chapterNumber: 13,
      bloomLevel: 'KNOWLEDGE',
      question: 'Vad är extern fixation?',
      options: [
        { text: 'Frakturstabilisering med stift genom hud och extern ram', correct: true },
        { text: 'Gipsbehandling', correct: false },
        { text: 'Märgspik', correct: false },
        { text: 'Platta och skruvar', correct: false },
      ],
      explanation: 'Extern fixation använder perkutana pinnar förbundna med extern ram för snabb stabilisering.',
      reference: 'B-ORTIM Kursbok, Kapitel 13',
    },
    {
      code: '13.11',
      chapterNumber: 13,
      bloomLevel: 'COMPREHENSION',
      question: 'Fördelar med extern fixation vid DCO?',
      options: [
        { text: 'Snabb, minimal blodförlust, undviker märgrumsintrång', correct: true },
        { text: 'Bäst för slutlig behandling', correct: false },
        { text: 'Kräver ingen anestesi', correct: false },
        { text: 'Ger bäst funktion', correct: false },
      ],
      explanation: 'Extern fix är snabb, blöder minimalt och undviker märgrumspåverkan som kan ge embolier.',
      reference: 'B-ORTIM Kursbok, Kapitel 13',
    },
    {
      code: '13.12',
      chapterNumber: 13,
      bloomLevel: 'KNOWLEDGE',
      question: 'Vad är SIRS?',
      options: [
        { text: 'Systemic Inflammatory Response Syndrome', correct: true },
        { text: 'Severe Injury Response Score', correct: false },
        { text: 'Surgical Intervention Risk Scale', correct: false },
        { text: 'Standard Injury Rating System', correct: false },
      ],
      explanation: 'SIRS är det systemiska inflammatoriska svaret på allvarlig skada, infektion eller kirurgi.',
      reference: 'B-ORTIM Kursbok, Kapitel 13',
    },
    {
      code: '13.13',
      chapterNumber: 13,
      bloomLevel: 'KNOWLEDGE',
      question: 'Vad är MODS?',
      options: [
        { text: 'Multiple Organ Dysfunction Syndrome', correct: true },
        { text: 'Major Orthopaedic Damage Score', correct: false },
        { text: 'Minimal Operative Damage Strategy', correct: false },
        { text: 'Modified Organ Damage Scale', correct: false },
      ],
      explanation: 'MODS är progressiv dysfunktion av flera organsystem efter svår skada eller sjukdom.',
      reference: 'B-ORTIM Kursbok, Kapitel 13',
    },
    {
      code: '13.14',
      chapterNumber: 13,
      bloomLevel: 'APPLICATION',
      question: 'Patient med bilateral femurfraktur och lungkontusion. Behandlingsstrategi?',
      options: [
        { text: 'DCO med extern fixation - hög risk för ARDS vid tidig märgspikning', correct: true },
        { text: 'Bilateral märgspikning dag 1', correct: false },
        { text: 'Konservativ behandling', correct: false },
        { text: 'Vänta en vecka', correct: false },
      ],
      explanation: 'Lungkontusion + bilateral femurfraktur = hög ARDS-risk. DCO med extern fix minskar second hit.',
      reference: 'B-ORTIM Kursbok, Kapitel 13; Pape HC J Trauma 2007',
    },
    {
      code: '13.15',
      chapterNumber: 13,
      bloomLevel: 'KNOWLEDGE',
      question: 'När konverteras extern fixation till definitiv fixation?',
      options: [
        { text: 'När patienten är fysiologiskt stabil, vanligen dag 5-10', correct: true },
        { text: 'Alltid inom 24 timmar', correct: false },
        { text: 'Aldrig - extern fix är definitiv', correct: false },
        { text: 'Efter 6 veckor', correct: false },
      ],
      explanation: 'Konvertering sker när lethal triad korrigerats och patienten är optimerad - typiskt dag 5-10.',
      reference: 'B-ORTIM Kursbok, Kapitel 13',
    },
    {
      code: '13.16',
      chapterNumber: 13,
      bloomLevel: 'KNOWLEDGE',
      question: 'Vad är ISS (Injury Severity Score)?',
      options: [
        { text: 'Anatomisk skadegraderingsscore baserad på AIS', correct: true },
        { text: 'Fysiologisk score', correct: false },
        { text: 'Bara för ortopediska skador', correct: false },
        { text: 'Blodtrycksbaserad score', correct: false },
      ],
      explanation: 'ISS sumerar kvadrerade AIS-värden för de tre mest skadade kroppsregionerna (max 75).',
      reference: 'B-ORTIM Kursbok, Kapitel 13; Baker SP J Trauma 1974',
    },
    {
      code: '13.17',
      chapterNumber: 13,
      bloomLevel: 'APPLICATION',
      question: 'ISS >25 indikerar vad?',
      options: [
        { text: 'Svårt multitrauma med ökad risk för komplikationer', correct: true },
        { text: 'Lindrig skada', correct: false },
        { text: 'Endast ortopedisk skada', correct: false },
        { text: 'Att patienten kan opereras direkt', correct: false },
      ],
      explanation: 'ISS >25 definierar major trauma och är associerat med ökad mortalitet och komplikationsrisk.',
      reference: 'B-ORTIM Kursbok, Kapitel 13',
    },
    {
      code: '13.18',
      chapterNumber: 13,
      bloomLevel: 'KNOWLEDGE',
      question: 'Vad är "borderline patient" vid trauma?',
      options: [
        { text: 'Patient vars fysiologiska status gör behandlingsvalet osäkert', correct: true },
        { text: 'Patient med personlighetsstörning', correct: false },
        { text: 'Patient som vägrar behandling', correct: false },
        { text: 'Patient med gränsvärdes-lab', correct: false },
      ],
      explanation: 'Borderline patient är fysiologiskt på gränsen - varken helt stabil (ETC) eller helt instabil (DCO).',
      reference: 'B-ORTIM Kursbok, Kapitel 13; Pape HC J Orthop Trauma 2009',
    },
    {
      code: '13.19',
      chapterNumber: 13,
      bloomLevel: 'KNOWLEDGE',
      question: 'Vilka labprover är viktiga att följa vid DCO?',
      options: [
        { text: 'Laktat, pH, Hb, TPK, PK-INR, fibrinogen', correct: true },
        { text: 'Endast Hb', correct: false },
        { text: 'Endast CRP', correct: false },
        { text: 'Labprover är inte viktiga', correct: false },
      ],
      explanation: 'Laktat och pH visar perfusion, koagulationsprover (TPK, PK, fibrinogen) visar koagulopati.',
      reference: 'B-ORTIM Kursbok, Kapitel 13',
    },
    {
      code: '13.20',
      chapterNumber: 13,
      bloomLevel: 'COMPREHENSION',
      question: 'Vad indikerar stigande laktat hos traumapatient?',
      options: [
        { text: 'Otillräcklig vävnadsperfusion och anaerob metabolism', correct: true },
        { text: 'God prognos', correct: false },
        { text: 'Infektion endast', correct: false },
        { text: 'Dehydrering', correct: false },
      ],
      explanation: 'Stigande laktat indikerar otillräcklig syretillförsel till vävnader - tecken på chock.',
      reference: 'B-ORTIM Kursbok, Kapitel 13',
    },
    {
      code: '13.21',
      chapterNumber: 13,
      bloomLevel: 'KNOWLEDGE',
      question: 'Vad är MTP (Massive Transfusion Protocol)?',
      options: [
        { text: 'Strukturerad tillförsel av blodprodukter i balanserad ratio', correct: true },
        { text: 'Endast erytrocyter', correct: false },
        { text: 'Kristalloidprotokoll', correct: false },
        { text: 'Trombocytkoncentrat endast', correct: false },
      ],
      explanation: 'MTP ger balanserad transfusion (erytrocyter:plasma:trombocyter 1:1:1) vid massiv blödning.',
      reference: 'B-ORTIM Kursbok, Kapitel 13; PROPPR Trial JAMA 2015',
    },
    {
      code: '13.22',
      chapterNumber: 13,
      bloomLevel: 'KNOWLEDGE',
      question: 'Vad är TXA och dess roll vid trauma?',
      options: [
        { text: 'Tranexamsyra - antifibrinolytikum som minskar mortalitet inom 3h', correct: true },
        { text: 'Antibiotikum', correct: false },
        { text: 'Smärtstillande', correct: false },
        { text: 'Blodtryckshöjare', correct: false },
      ],
      explanation: 'TXA hämmar fibrinolys och minskar mortalitet vid traumatisk blödning om givet inom 3 timmar.',
      reference: 'B-ORTIM Kursbok, Kapitel 13; CRASH-2 Lancet 2010',
    },
    {
      code: '13.23',
      chapterNumber: 13,
      bloomLevel: 'KNOWLEDGE',
      question: 'Vad är permissive hypotension?',
      options: [
        { text: 'Tillåta lägre blodtryck (SBT 80-90) tills blödning kontrollerats', correct: true },
        { text: 'Alltid högt blodtryck', correct: false },
        { text: 'Lågt blodtryck är alltid farligt', correct: false },
        { text: 'Ge mycket vätska', correct: false },
      ],
      explanation: 'Permissive hypotension undviker överdriven vätskeresuscitation som kan förvärra blödning.',
      reference: 'B-ORTIM Kursbok, Kapitel 13; ATLS 10th ed',
    },
    {
      code: '13.24',
      chapterNumber: 13,
      bloomLevel: 'APPLICATION',
      question: 'Multitraumapatient som genomgått DCO. När planeras definitiv kirurgi?',
      options: [
        { text: 'När lethal triad korrigerats och patient är optimerad (dag 5-10)', correct: true },
        { text: 'Samma dag', correct: false },
        { text: 'Efter 3 månader', correct: false },
        { text: 'Aldrig', correct: false },
      ],
      explanation: 'Definitiv kirurgi planeras när patienten är ur lethal triad med stabil hemodynamik.',
      reference: 'B-ORTIM Kursbok, Kapitel 13',
    },
    {
      code: '13.25',
      chapterNumber: 13,
      bloomLevel: 'KNOWLEDGE',
      question: 'Vad är IVA-vård fokuserad på vid DCO-patienter?',
      options: [
        { text: 'Värme, korrigera acidos, optimera koagulation, andningsvård', correct: true },
        { text: 'Endast smärtstillande', correct: false },
        { text: 'Endast nutrition', correct: false },
        { text: 'Endast övervakning', correct: false },
      ],
      explanation: 'IVA korrigerar lethal triad (värme, bikarbonat, blodprodukter) och optimerar inför definitiv kirurgi.',
      reference: 'B-ORTIM Kursbok, Kapitel 13',
    },
    {
      code: '13.26',
      chapterNumber: 13,
      bloomLevel: 'COMPREHENSION',
      question: 'Hur värms en hypoterm traumapatient?',
      options: [
        { text: 'Varma vätskor, varmluftstäcke, värmd miljö', correct: true },
        { text: 'Endast filtar', correct: false },
        { text: 'Kalla vätskor', correct: false },
        { text: 'Värmning är inte viktigt', correct: false },
      ],
      explanation: 'Aktiv uppvärmning: varma IV-vätskor, varmluftstäcke, varm sal, minimera exponering.',
      reference: 'B-ORTIM Kursbok, Kapitel 13',
    },
    {
      code: '13.27',
      chapterNumber: 13,
      bloomLevel: 'APPLICATION',
      question: 'Traumapatient med skallskada (GCS 8) och femurfraktur. Strategi?',
      options: [
        { text: 'Neurointensivvård prioriteras, tidig extern fix av femur', correct: true },
        { text: 'Femurspikning först', correct: false },
        { text: 'Ignorera femurfrakturen', correct: false },
        { text: 'Vänta med all behandling', correct: false },
      ],
      explanation: 'Vid kombination skallskada + fraktur: neuro prioriteras, tidig frakturstabilisering minskar sekundär skada.',
      reference: 'B-ORTIM Kursbok, Kapitel 13',
    },
    {
      code: '13.28',
      chapterNumber: 13,
      bloomLevel: 'KNOWLEDGE',
      question: 'Risk med fördröjd konvertering från extern fixation?',
      options: [
        { text: 'Ökad infektionsrisk från pin-sites', correct: true },
        { text: 'Bättre läkning', correct: false },
        { text: 'Ingen risk', correct: false },
        { text: 'Minskad operationstid', correct: false },
      ],
      explanation: 'Pin-sites koloniseras över tid - konvertering efter >2 veckor har ökad djup infektionsrisk.',
      reference: 'B-ORTIM Kursbok, Kapitel 13; Bhandari M J Orthop Trauma 2005',
    },
    {
      code: '13.29',
      chapterNumber: 13,
      ...
      question: 'Vad innebär "damage control resuscitation"?',
      options: [
        { text: 'Tidig blödningskontroll, permissive hypotension, balanserad transfusion', correct: true },
        { text: 'Endast vätska', correct: false },
        { text: 'Endast kirurgi', correct: false },
        { text: 'Endast antibiotika', correct: false },
      ],
      explanation: 'DCR är helhetsstrategin: tidig hemostas, undvika kristalloid, balanserad MTP, förhindra hypotermi.',
      reference: 'B-ORTIM Kursbok, Kapitel 13; Holcomb JB Lancet 2007',
    },
    {
      code: '13.30',
      chapterNumber: 13,
      bloomLevel: 'COMPREHENSION',
      question: 'Varför är teamarbete extra viktigt vid DCO?',
      options: [
        { text: 'Multipla specialiteter måste prioritera och koordinera simultant', correct: true },
        { text: 'Det är enklare', correct: false },
        { text: 'Bara en läkare behövs', correct: false },
        { text: 'Teamarbete är inte viktigt', correct: false },
      ],
      explanation: 'DCO kräver samordning: traumakirurg, ortoped, neurokirurg, anestesiolog, IVA.',
      reference: 'B-ORTIM Kursbok, Kapitel 13',
    },
    {
      code: '13.31',
      chapterNumber: 13,
      bloomLevel: 'APPLICATION',
      question: 'DCO-patient med bäckenfraktur och femurfraktur. Prioritetsordning?',
      options: [
        { text: 'Bäckenstabilisering först (blödningskontroll), sedan femur', correct: true },
        { text: 'Femur först', correct: false },
        { text: 'Behandla ej bäckenet', correct: false },
        { text: 'Samma prioritet', correct: false },
      ],
      explanation: 'Bäckenblödning är mer livshotande - stabilisera bäckenet först, sedan extremiteter.',
      reference: 'B-ORTIM Kursbok, Kapitel 13',
    },
    {
      code: '13.32',
      chapterNumber: 13,
      bloomLevel: 'ANALYSIS',
      question: 'Vad är viktigast för bra utfall vid DCO?',
      options: [
        { text: 'Tidig identifiering av riskpatient och rätt timing av interventioner', correct: true },
        { text: 'Bästa kirurgiska teknik', correct: false },
        { text: 'Dyra implantat', correct: false },
        { text: 'Lång operationstid', correct: false },
      ],
      explanation: 'Bästa utfall uppnås genom att identifiera vilka som behöver DCO och optimera timing.',
      reference: 'B-ORTIM Kursbok, Kapitel 13; Pape HC J Trauma 2007',
    },

    // Kapitel 14: Transport - fler frågor
    {
      code: '14.3',
      chapterNumber: 14,
      bloomLevel: 'KNOWLEDGE',
      question: 'Vad innebär primär överföring av traumapatient?',
      options: [
        { text: 'Direkt transport från skadeplats till definitiv vård', correct: true },
        { text: 'Transport mellan sjukhus', correct: false },
        { text: 'Transport inom sjukhus', correct: false },
        { text: 'Transport hem', correct: false },
      ],
      explanation: 'Primär överföring är transport direkt från skadeplats till lämplig vårdnivå.',
      reference: 'B-ORTIM Kursbok, Kapitel 14',
    },
    {
      code: '14.4',
      chapterNumber: 14,
      bloomLevel: 'KNOWLEDGE',
      question: 'Vad innebär sekundär överföring?',
      options: [
        { text: 'Transport mellan sjukhus för högre vårdnivå', correct: true },
        { text: 'Direkt från skadeplats', correct: false },
        { text: 'Transport inom samma sjukhus', correct: false },
        { text: 'Transport hem', correct: false },
      ],
      explanation: 'Sekundär överföring är transport från ett sjukhus till annat för specialiserad vård.',
      reference: 'B-ORTIM Kursbok, Kapitel 14',
    },
    {
      code: '14.5',
      chapterNumber: 14,
      bloomLevel: 'COMPREHENSION',
      question: 'Vilka risker finns vid transport av traumapatient?',
      options: [
        { text: 'Hypotermi, hypoxemi, förlorad IV-access, försämrad monitorering', correct: true },
        { text: 'Inga risker', correct: false },
        { text: 'Endast försenad vård', correct: false },
        { text: 'Endast åksjuka', correct: false },
      ],
      explanation: 'Transport innebär risker: kylning, syrgasbrist, förlorad access, svårare att monitorera.',
      reference: 'B-ORTIM Kursbok, Kapitel 14',
    },
    {
      code: '14.6',
      chapterNumber: 14,
      bloomLevel: 'APPLICATION',
      question: 'Vad ska kontrolleras innan transport av traumapatient?',
      options: [
        { text: 'ABCDE säkrat, immobilisering, IV-access, monitorering, dokumentation', correct: true },
        { text: 'Endast identitet', correct: false },
        { text: 'Endast läkemedel', correct: false },
        { text: 'Endast frakturläge', correct: false },
      ],
      explanation: 'Transportchecklista: stabil luftväg, andning, cirkulation, immobilisering, fungerande infarter.',
      reference: 'B-ORTIM Kursbok, Kapitel 14; ATLS 10th ed',
    },
    {
      code: '14.7',
      chapterNumber: 14,
      bloomLevel: 'KNOWLEDGE',
      question: 'Vad innebär "stay and play" vs "scoop and run"?',
      options: [
        { text: 'Behandla på plats vs snabb transport med minimal fältbehandling', correct: true },
        { text: 'Olika ambulanstyper', correct: false },
        { text: 'Samma sak', correct: false },
        { text: 'Idrottsrelaterade termer', correct: false },
      ],
      explanation: 'Stay and play: avancerad fältbehandling. Scoop and run: minimal fälttid, snabb transport.',
      reference: 'B-ORTIM Kursbok, Kapitel 14',
    },
    {
      code: '14.8',
      chapterNumber: 14,
      bloomLevel: 'KNOWLEDGE',
      question: 'Hur immobiliseras extremitetsfraktur för transport?',
      options: [
        { text: 'Spjäla leden ovan och nedan frakturen, kontrollera DMS', correct: true },
        { text: 'Endast kompress', correct: false },
        { text: 'Ingen immobilisering behövs', correct: false },
        { text: 'Reponera alltid först', correct: false },
      ],
      explanation: 'Immobilisera genom att fixera led ovan och nedan, kontrollera distal cirkulation.',
      reference: 'B-ORTIM Kursbok, Kapitel 14; ATLS 10th ed',
    },
    {
      code: '14.9',
      chapterNumber: 14,
      bloomLevel: 'KNOWLEDGE',
      question: 'Vad är SBAR?',
      options: [
        { text: 'Strukturerat kommunikationsverktyg: Situation, Background, Assessment, Recommendation', correct: true },
        { text: 'Skadegrad', correct: false },
        { text: 'Typ av ambulans', correct: false },
        { text: 'Blodtrycksmätare', correct: false },
      ],
      explanation: 'SBAR är kommunikationsmodell för säker överrapportering.',
      reference: 'B-ORTIM Kursbok, Kapitel 14',
    },
    {
      code: '14.10',
      chapterNumber: 14,
      bloomLevel: 'COMPREHENSION',
      question: 'Varför är strukturerad överrapportering viktig?',
      options: [
        { text: 'Minskar informationsförlust och missförstånd vid vårdövergång', correct: true },
        { text: 'Det tar kortare tid', correct: false },
        { text: 'Juridiskt krav endast', correct: false },
        { text: 'Inte viktigt', correct: false },
      ],
      explanation: 'Strukturerad kommunikation minskar risk för att kritisk information tappas vid överlämning.',
      reference: 'B-ORTIM Kursbok, Kapitel 14',
    },
    {
      code: '14.11',
      chapterNumber: 14,
      bloomLevel: 'KNOWLEDGE',
      question: 'När ska helikoptertransport övervägas?',
      options: [
        { text: 'Lång transportsträcka, tidskritisk skada, otillgänglig terräng', correct: true },
        { text: 'Alltid', correct: false },
        { text: 'Aldrig vid trauma', correct: false },
        { text: 'Endast vid hjärtstopp', correct: false },
      ],
      explanation: 'Helikopter övervägs vid >30-45 min marktransport till traumacentrum, svår terräng.',
      reference: 'B-ORTIM Kursbok, Kapitel 14',
    },
    {
      code: '14.12',
      chapterNumber: 14,
      bloomLevel: 'KNOWLEDGE',
      question: 'Vad innebär triage vid masskadesituation?',
      options: [
        { text: 'Sortering av patienter efter skadegrad och behandlingsprioritet', correct: true },
        { text: 'Behandla alla samtidigt', correct: false },
        { text: 'Först till kvarn', correct: false },
        { text: 'Endast transport', correct: false },
      ],
      explanation: 'Triage: systematisk prioritering för att ge rätt vård vid begränsade resurser.',
      reference: 'B-ORTIM Kursbok, Kapitel 14',
    },
    {
      code: '14.13',
      chapterNumber: 14,
      bloomLevel: 'KNOWLEDGE',
      question: 'Vilka triagekategorier används vanligen?',
      options: [
        { text: 'Röd (omedelbar), Gul (kan vänta), Grön (lindrig), Svart (avliden)', correct: true },
        { text: 'Endast röd och grön', correct: false },
        { text: 'A, B, C, D', correct: false },
        { text: 'Samma för alla', correct: false },
      ],
      explanation: 'START-triage: Röd (immediate), Gul (delayed), Grön (minor), Svart (deceased).',
      reference: 'B-ORTIM Kursbok, Kapitel 14',
    },
    {
      code: '14.14',
      chapterNumber: 14,
      bloomLevel: 'KNOWLEDGE',
      question: 'Vad innebär "golden hour" vid trauma?',
      options: [
        { text: 'Första timmen då definitiv behandling förbättrar överlevnad', correct: true },
        { text: 'Bästa tid på dygnet', correct: false },
        { text: 'En timmes vila', correct: false },
        { text: 'Gyllene smycken', correct: false },
      ],
      explanation: 'Golden hour: konceptet att tidig definitiv vård förbättrar utfall vid svårt trauma.',
      reference: 'B-ORTIM Kursbok, Kapitel 14; Cowley RA 1975',
    },
    {
      code: '14.15',
      chapterNumber: 14,
      bloomLevel: 'KNOWLEDGE',
      question: 'Hur förebyggs hypotermi under transport?',
      options: [
        { text: 'Täck patienten, varm ambulans, varma vätskor, undvik exponering', correct: true },
        { text: 'Hypotermi är inte ett problem', correct: false },
        { text: 'Ge kalla vätskor', correct: false },
        { text: 'Öppna fönster', correct: false },
      ],
      explanation: 'Förebygg hypotermi: filtar, varm miljö, varma IV-vätskor, minimera exponering.',
      reference: 'B-ORTIM Kursbok, Kapitel 14',
    },
    {
      code: '14.16',
      chapterNumber: 14,
      bloomLevel: 'APPLICATION',
      question: 'Vilken smärtlindring är lämplig prehospitalt vid femurfraktur?',
      options: [
        { text: 'IV morfin/fentanyl titrerat, alternativt intranasal fentanyl', correct: true },
        { text: 'Endast paracetamol po', correct: false },
        { text: 'Ingen smärtstillande prehospitalt', correct: false },
        { text: 'Ryggmärgsbedövning', correct: false },
      ],
      explanation: 'Prehospital analgesi: IV opioid titrerat, eller intranasal/IM om IV ej möjligt.',
      reference: 'B-ORTIM Kursbok, Kapitel 14',
    },
    {
      code: '14.17',
      chapterNumber: 14,
      bloomLevel: 'COMPREHENSION',
      question: 'Varför är smärtlindring viktig före transport?',
      options: [
        { text: 'Minskar stress, underlättar immobilisering, förbättrar fysiologi', correct: true },
        { text: 'Endast för patientens komfort', correct: false },
        { text: 'Inte viktigt', correct: false },
        { text: 'Ska ges först på sjukhus', correct: false },
      ],
      explanation: 'Smärta ökar stress och försämrar ventilation. Adekvat analgesi före transport.',
      reference: 'B-ORTIM Kursbok, Kapitel 14',
    },
    {
      code: '14.18',
      chapterNumber: 14,
      bloomLevel: 'COMPREHENSION',
      question: 'Varför är tidig anmälan till mottagande sjukhus viktig?',
      options: [
        { text: 'Ger tid att förbereda rätt team och resurser', correct: true },
        { text: 'Endast för statistik', correct: false },
        { text: 'Inte nödvändigt', correct: false },
        { text: 'Juridiskt krav endast', correct: false },
      ],
      explanation: 'Tidig anmälan tillåter traumateam-aktivering, förberedelse av OP/IVA.',
      reference: 'B-ORTIM Kursbok, Kapitel 14',
    },
    {
      code: '14.19',
      chapterNumber: 14,
      bloomLevel: 'APPLICATION',
      question: 'Information som ska ges vid tidig anmälan av traumapatient?',
      options: [
        { text: 'Ålder, kön, mekanism, skador, vitaler, ETA, speciella behov', correct: true },
        { text: 'Endast patientnamn', correct: false },
        { text: 'Endast ankomsttid', correct: false },
        { text: 'Ingen information behövs', correct: false },
      ],
      explanation: 'Pre-alert: demografik, skademekanism, skador, vitaler, beräknad ankomsttid.',
      reference: 'B-ORTIM Kursbok, Kapitel 14',
    },
    {
      code: '14.20',
      chapterNumber: 14,
      bloomLevel: 'APPLICATION',
      question: 'Vem ansvarar för patienten under transport?',
      options: [
        { text: 'Sändande enhet tills mottagande accepterat och tagit över', correct: true },
        { text: 'Ambulanspersonal', correct: false },
        { text: 'Mottagande enhet från start', correct: false },
        { text: 'Ingen', correct: false },
      ],
      explanation: 'Sändande enhet behåller ansvar tills formell överlämning sker.',
      reference: 'B-ORTIM Kursbok, Kapitel 14',
    },
    ...
    // Kapitel 15: Dokumentation och juridik
    {
      ...
      chapterNumber: 15,
      bloomLevel: 'KNOWLEDGE',
      question: 'Vilka krav ställs på medicinsk dokumentation vid trauma?',
      options: [
        { text: 'Tidpunkter, fynd, bedömning, åtgärder, ansvarig', correct: true },
        { text: 'Endast diagnos', correct: false },
        { text: 'Endast behandling', correct: false },
        { text: 'Dokumentation är frivillig', correct: false },
      ],
      explanation: 'Dokumentation ska innehålla tid, objektiva fynd, bedömning, åtgärder och vem som ansvarar.',
      reference: 'B-ORTIM Kursbok, Kapitel 15; Patientdatalagen',
    },
    {
      code: '15.4',
      chapterNumber: 15,
      bloomLevel: 'COMPREHENSION',
      question: 'Varför är noggrann dokumentation viktig vid trauma?',
      options: [
        { text: 'Patientvård, kommunikation, juridiskt skydd, kvalitetsuppföljning', correct: true },
        { text: 'Endast för fakturering', correct: false },
        { text: 'Inte viktigt', correct: false },
        { text: 'Endast för statistik', correct: false },
      ],
      explanation: 'Dokumentation säkerställer vårdkontinuitet, underlättar överföring och ger juridiskt skydd.',
      reference: 'B-ORTIM Kursbok, Kapitel 15',
    },
    {
      code: '15.5',
      chapterNumber: 15,
      bloomLevel: 'KNOWLEDGE',
      question: 'Vad ska dokumenteras vid extremitetsskada?',
      options: [
        { text: 'Skademekanism, kliniska fynd, DMS-status, röntgen, behandling', correct: true },
        { text: 'Endast röntgenfynd', correct: false },
        { text: 'Endast behandling', correct: false },
        { text: 'Ingenting specifikt', correct: false },
      ],
      explanation: 'Dokumentera mekanism, status (inklusive DMS), bilddiagnostik och given behandling.',
      reference: 'B-ORTIM Kursbok, Kapitel 15',
    },
    {
      code: '15.6',
      ...
      options: [
        { text: 'Patient informeras om åtgärd, risker och alternativ och godkänner', correct: true },
        { text: 'Läkaren bestämmer', correct: false },
        { text: 'Skriftligt kontrakt alltid', correct: false },
        { text: 'Anhöriga bestämmer', correct: false },
      ],
      explanation: 'Informerat samtycke kräver att patienten förstår vad som ska göras, varför, och risker/alternativ.',
      reference: 'B-ORTIM Kursbok, Kapitel 15; Patientlagen',
    },
    {
      code: '15.7',
      chapterNumber: 15,
      bloomLevel: 'APPLICATION',
      question: 'Medvetslös traumapatient behöver akut kirurgi. Vad gäller för samtycke?',
      options: [
        { text: 'Presumerat samtycke - akut livräddande åtgärder får utföras', correct: true },
        { text: 'Vänta tills patienten vaknar', correct: false },
        { text: 'Anhöriga måste godkänna', correct: false },
        { text: 'Operera ej utan skriftligt samtycke', correct: false },
      ],
      explanation: 'Vid akut nödsituation med medvetslös patient gäller presumerat samtycke för livräddande åtgärder.',
      reference: 'B-ORTIM Kursbok, Kapitel 15; Patientlagen',
    },
    {
      code: '15.8',
      ...
      options: [
        { text: 'Skyldighet att anmäla allvarliga vårdskador till IVO', correct: true },
        { text: 'Patientförsäkring', correct: false },
        { text: 'Läkemedelslag', correct: false },
        { text: 'Smittskyddslag', correct: false },
      ],
      explanation: 'Lex Maria innebär skyldighet att anmäla händelser som medfört eller kunnat medföra allvarlig vårdskada.',
      reference: 'B-ORTIM Kursbok, Kapitel 15; Patientsäkerhetslagen',
    },
    {
      code: '15.9',
      chapterNumber: 15,
      bloomLevel: 'COMPREHENSION',
      question: 'Vad är syftet med avvikelserapportering?',
      options: [
        { text: 'Lära av misstag och förbättra vårdsäkerheten', correct: true },
        { text: 'Straffa personal', correct: false },
        { text: 'Endast dokumentation', correct: false },
        { text: 'Försäkringsärenden', correct: false },
      ],
      explanation: 'Avvikelserapportering syftar till att identifiera risker och förbättra systemet, inte att straffa.',
      reference: 'B-ORTIM Kursbok, Kapitel 15',
    },
    {
      code: '15.10',
      chapterNumber: 15,
      bloomLevel: 'KNOWLEDGE',
      question: 'Vad är sekretess inom hälso- och sjukvård?',
      options: [
        { text: 'Tystnadsplikt om patientuppgifter gentemot obehöriga', correct: true },
        { text: 'Endast gentemot media', correct: false },
        { text: 'Gäller endast skriftlig info', correct: false },
        { text: 'Finns ej inom sjukvården', correct: false },
      ],
      explanation: 'Sekretess innebär att patientuppgifter ej får lämnas ut till obehöriga utan patientens samtycke.',
      reference: 'B-ORTIM Kursbok, Kapitel 15; Offentlighets- och sekretesslagen',
    },
    {
      code: '15.11',
      chapterNumber: 15,
      bloomLevel: 'APPLICATION',
      question: 'Polis vill ha information om traumapatient. Vad gäller?',
      options: [
        { text: 'Sekretess gäller - information lämnas endast vid viss lagstöd eller patientens samtycke', correct: true },
        { text: 'Polis har alltid rätt till information', correct: false },
        { text: 'Lämna aldrig ut något', correct: false },
        { text: 'Beror på vilken polis', correct: false },
      ],
      explanation: 'Sekretess gentemot polis bryts endast vid specifikt lagstöd (t.ex. grov brottslighet) eller samtycke.',
      reference: 'B-ORTIM Kursbok, Kapitel 15; Offentlighets- och sekretesslagen',
    },
    {
      code: '15.12',
      chapterNumber: 15,
      bloomLevel: 'KNOWLEDGE',
      question: 'Vad är patientskadelagen?',
      options: [
        { text: 'Lag som ger rätt till ersättning vid vårdskada utan att styrka fel', correct: true },
        { text: 'Strafflag för vårdpersonal', correct: false },
        { text: 'Lag om patientjournaler', correct: false },
        { text: 'Lag om smittskydd', correct: false },
      ],
      explanation: 'Patientskadelagen ger rätt till ersättning vid undvikbar skada - kräver inte att fel bevisas.',
      reference: 'B-ORTIM Kursbok, Kapitel 15; Patientskadelagen',
    },
    {
      code: '15.13',
      chapterNumber: 15,
      bloomLevel: 'KNOWLEDGE',
      question: 'Hur länge ska patientjournaler sparas?',
      options: [
        { text: 'Minst 10 år efter senaste anteckning', correct: true },
        { text: '1 år', correct: false },
        { text: '5 år', correct: false },
        { text: 'Behöver ej sparas', correct: false },
      ],
      explanation: 'Patientjournaler ska bevaras minst 10 år efter senaste anteckning enligt Patientdatalagen.',
      reference: 'B-ORTIM Kursbok, Kapitel 15; Patientdatalagen',
    },
    {
      code: '15.14',
      chapterNumber: 15,
      bloomLevel: 'APPLICATION',
      question: 'Hur dokumenteras tourniquet-applikation?',
      options: [
        { text: 'Exakt tid för applicering, indikation, och markering på patient', correct: true },
        { text: 'Endast att tourniquet använts', correct: false },
        { text: 'Dokumentation ej nödvändig', correct: false },
        { text: 'Endast i ambulansjournal', correct: false },
      ],
      explanation: 'Dokumentera exakt appliceringtid (livstidskritisk info), indikation och markera "TK" + tid på patienten.',
      reference: 'B-ORTIM Kursbok, Kapitel 15',
    },
    {
      code: '15.15',
      chapterNumber: 15,
      bloomLevel: 'COMPREHENSION',
      question: 'Varför ska all given behandling dokumenteras med tidpunkt?',
      options: [
        { text: 'Möjliggör utvärdering av behandlingseffekt och undviker dubblering', correct: true },
        { text: 'Endast för statistik', correct: false },
        { text: 'Tidpunkt är inte viktigt', correct: false },
        { text: 'Juridiskt krav endast', correct: false },
      ],
      explanation: 'Tidsstämpling av åtgärder möjliggör korrelation med fynd och förhindrar överdosering.',
      reference: 'B-ORTIM Kursbok, Kapitel 15',
    },
    ...
    // Kapitel 16: Teamarbete och kommunikation
    {
      ...
      chapterNumber: 16,
      bloomLevel: 'KNOWLEDGE',
      question: 'Vad är CRM (Crew Resource Management)?',
      options: [
        { text: 'Strukturerad metod för effektivt teamarbete och säkerhet', correct: true },
        { text: 'Datorprogram', correct: false },
        { text: 'Medicinsk teknik', correct: false },
        { text: 'Typ av kirurgi', correct: false },
      ],
      explanation: 'CRM är ett ramverk för att optimera teamkommunikation, ledarskap och säkerhet.',
      reference: 'B-ORTIM Kursbok, Kapitel 16',
    },
    {
      code: '16.4',
      chapterNumber: 16,
      bloomLevel: 'KNOWLEDGE',
      question: 'Vad innebär "closed loop communication"?',
      options: [
        { text: 'Avsändare ger order, mottagare repeterar, avsändare bekräftar', correct: true },
        { text: 'Envägs-kommunikation', correct: false },
        { text: 'Skriftlig kommunikation', correct: false },
        { text: 'Tyst kommunikation', correct: false },
      ],
      explanation: 'Closed loop: order ges, repeteras av mottagaren, bekräftas av avsändaren - minimerar missförstånd.',
      reference: 'B-ORTIM Kursbok, Kapitel 16',
    },
    {
      code: '16.5',
      chapterNumber: 16,
      bloomLevel: 'APPLICATION',
      question: 'Hur tillämpas closed loop vid läkemedelsordination?',
      options: [
        { text: '"Ge 5mg morfin IV" - "5mg morfin IV ges" - "Korrekt"', correct: true },
        { text: 'Endast skriva i journal', correct: false },
        { text: 'Nicka som bekräftelse', correct: false },
        { text: 'Closed loop används ej för läkemedel', correct: false },
      ],
      explanation: 'Läkare ordinerar, sjuksköterska repeterar dos/preparat/väg, läkare bekräftar.',
      reference: 'B-ORTIM Kursbok, Kapitel 16',
    },
    {
      code: '16.6',
      chapterNumber: 16,
      bloomLevel: 'KNOWLEDGE',
      question: 'Vad är teamledarens roll vid traumamottagning?',
      options: [
        { text: 'Överblick, koordinering, prioritering, kommunikation', correct: true },
        { text: 'Utföra alla åtgärder', correct: false },
        { text: 'Endast dokumentation', correct: false },
        { text: 'Stå utanför rummet', correct: false },
      ],
      explanation: 'Teamledaren har helikopterperspektiv, koordinerar insatser och fattar övergripande beslut.',
      reference: 'B-ORTIM Kursbok, Kapitel 16; ATLS 10th ed',
    },
    {
      code: '16.7',
      chapterNumber: 16,
      bloomLevel: 'COMPREHENSION',
      question: 'Varför är fördefinierade roller viktiga i traumateam?',
      options: [
        { text: 'Minskar förvirring och säkerställer att alla uppgifter utförs', correct: true },
        { text: 'Sparar pengar', correct: false },
        { text: 'Gör arbetet roligare', correct: false },
        { text: 'Roller är inte viktiga', correct: false },
      ],
      explanation: 'Tydliga roller förhindrar att uppgifter faller mellan stolarna och minskar kaos.',
      reference: 'B-ORTIM Kursbok, Kapitel 16',
    },
    {
      code: '16.8',
      chapterNumber: 16,
      bloomLevel: 'KNOWLEDGE',
      question: 'Vad är "speak up" i teamkommunikation?',
      options: [
        { text: 'Alla teammedlemmar uppmuntras att påtala oro eller avvikelser', correct: true },
        { text: 'Prata högt', correct: false },
        { text: 'Endast chefen talar', correct: false },
        { text: 'Tala efter mötet', correct: false },
      ],
      explanation: 'Speak up-kultur innebär att alla har ansvar och uppmuntras att säga ifrån vid oro eller fel.',
      reference: 'B-ORTIM Kursbok, Kapitel 16',
    },
    {
      code: '16.9',
      chapterNumber: 16,
      bloomLevel: 'COMPREHENSION',
      question: 'Vad är fixeringfel (tunnelseende)?',
      options: [
        { text: 'Att fokusera på en sak och missa andra viktiga fynd', correct: true },
        { text: 'Synproblem', correct: false },
        { text: 'Att sitta fast i bilen', correct: false },
        { text: 'Att frakturen fixeras', correct: false },
      ],
      explanation: 'Fixeringsfel innebär att fokusera på uppenbar skada och missa andra, potentiellt allvarligare problem.',
      reference: 'B-ORTIM Kursbok, Kapitel 16',
    },
    {
      code: '16.10',
      chapterNumber: 16,
      bloomLevel: 'APPLICATION',
      question: 'Hur undviks fixeringsfel vid traumamottagning?',
      options: [
        { text: 'Systematisk ABCDE-approach och regelbunden re-evaluering', correct: true },
        { text: 'Fokusera på mest synliga skadan', correct: false },
        { text: 'Lita på första intrycket', correct: false },
        { text: 'Hoppa över undersökning', correct: false },
      ],
      explanation: 'Systematiskt ABCDE-omhändertagande och återupprepade genomgångar förhindrar tunnel vision.',
      reference: 'B-ORTIM Kursbok, Kapitel 16; ATLS 10th ed',
    },
    {
      code: '16.11',
      chapterNumber: 16,
      bloomLevel: 'KNOWLEDGE',
      question: 'Vad är debrief efter traumafall?',
      options: [
        { text: 'Strukturerad genomgång av händelsen för lärande och förbättring', correct: true },
        { text: 'Kritik av enskilda', correct: false },
        { text: 'Endast vid misslyckande', correct: false },
        { text: 'Debriefing är onödigt', correct: false },
      ],
      explanation: 'Debrief är en strukturerad reflektion efter händelse för att identifiera vad som fungerade och vad som kan förbättras.',
      reference: 'B-ORTIM Kursbok, Kapitel 16',
    },
    {
      code: '16.12',
      chapterNumber: 16,
      bloomLevel: 'COMPREHENSION',
      question: 'Varför är simuleringsträning viktig för traumateam?',
      options: [
        { text: 'Möjliggör övning av sällsynta scenarier i säker miljö', correct: true },
        { text: 'Sparar på patienterna', correct: false },
        { text: 'Roligt för personalen', correct: false },
        { text: 'Simulering är inte effektivt', correct: false },
      ],
      explanation: 'Simulering ger möjlighet att träna kritiska situationer utan risk för patienter.',
      reference: 'B-ORTIM Kursbok, Kapitel 16',
    },
    {
      code: '16.13',
      ...
      options: [
        { text: 'Förståelse av vad som händer nu och vad som kan hända härnäst', correct: true },
        { text: 'Vara medveten om omgivningen', correct: false },
        { text: 'Endast ledarens ansvar', correct: false },
        { text: 'Samma som koncentration', correct: false },
      ],
      explanation: 'Situationsmedvetenhet: förstå nuläget, förutse utveckling och planera åtgärder.',
      reference: 'B-ORTIM Kursbok, Kapitel 16',
    },
    {
      code: '16.14',
      chapterNumber: 16,
      bloomLevel: 'ANALYSIS',
      question: 'Vad är viktigast för effektivt teamarbete vid trauma?',
      options: [
        { text: 'Tydlig kommunikation, definierade roller, gemensamma mentala modeller', correct: true },
        { text: 'Snabbhet', correct: false },
        { text: 'Hierarki', correct: false },
        { text: 'Individuell kompetens enbart', correct: false },
      ],
      explanation: 'Effektivt team kräver klar kommunikation, tydliga roller och delad förståelse av situationen.',
      reference: 'B-ORTIM Kursbok, Kapitel 16',
    },
    {
      code: '16.15',
      chapterNumber: 16,
      bloomLevel: 'COMPREHENSION',
      question: 'Hur hanteras konflikter i teamet under pågående trauma?',
      options: [
        { text: 'Teamledaren tar beslut, diskussion efter stabilisering', correct: true },
        { text: 'Stoppa behandlingen och diskutera', correct: false },
        { text: 'Ignorera konflikten', correct: false },
        { text: 'Låt patienten bestämma', correct: false },
      ],
      explanation: 'I akut situation tar teamledaren beslut. Konflikter och alternativ diskuteras efter att patienten stabiliserats.',
      reference: 'B-ORTIM Kursbok, Kapitel 16',
    },
    ...
    // Kapitel 17: Fallbaserad examination
    {
      ...
      chapterNumber: 17,
      bloomLevel: 'APPLICATION',
      question: '35-årig MC-förare, högenergiskada, deformerad underarm, blödning. Första prioritet?',
      options: [
        { text: 'C - stoppa blödning (tryck/tourniquet om massiv)', correct: true },
        { text: 'Röntgen', correct: false },
        { text: 'Smärtstillande', correct: false },
        { text: 'Gips', correct: false },
      ],
      explanation: 'Massiv blödning (cABCDE) är första prioritet - direkt tryck eller tourniquet vid extremitetsblödning.',
      reference: 'B-ORTIM Kursbok, Kapitel 17; TCCC Guidelines',
    },
    {
      code: '17.4',
      chapterNumber: 17,
      bloomLevel: 'APPLICATION',
      question: 'Patient med tibiafraktur utvecklar ökande smärta trots analgesi, spänd vad. Diagnos?',
      options: [
        { text: 'Kompartmentsyndrom', correct: true },
        { text: 'Fraktursmärta', correct: false },
        { text: 'DVT', correct: false },
        { text: 'Infektion', correct: false },
      ],
      explanation: 'Ökande smärta trots analgesi + spänd logg är klassisk bild av kompartmentsyndrom - akut tillstånd.',
      reference: 'B-ORTIM Kursbok, Kapitel 17',
    },
    {
      code: '17.5',
      chapterNumber: 17,
      bloomLevel: 'APPLICATION',
      question: 'Öppen tibiafraktur Gustilo IIIA, stabil patient. Behandlingsplan?',
      options: [
        { text: 'Antibiotika, tetanus, debridering inom 12-24h, fixation', correct: true },
        { text: 'Endast gips', correct: false },
        { text: 'Vänta och se', correct: false },
        { text: 'Antibiotika endast', correct: false },
      ],
      explanation: 'Öppen fraktur: antibiotika + tetanus omedelbart, kirurgisk debridering och stabilisering.',
      reference: 'B-ORTIM Kursbok, Kapitel 17; BOA/BAPRAS 2020',
    },
    {
      code: '17.6',
      chapterNumber: 17,
      bloomLevel: 'APPLICATION',
      question: 'Bäckenfraktur med SBT 85, HR 120 trots 2L kristalloid. Nästa steg?',
      options: [
        { text: 'Bäckenbälte, MTP, överväg preperitoneal packing/angio', correct: true },
        { text: 'Mer kristalloid', correct: false },
        { text: 'CT först', correct: false },
        { text: 'Vänta och se', correct: false },
      ],
      explanation: 'Hemodynamiskt instabil bäckenfraktur: mekanisk stabilisering + MTP + intervention (packing/angio).',
      reference: 'B-ORTIM Kursbok, Kapitel 17',
    },
    {
      code: '17.7',
      chapterNumber: 17,
      bloomLevel: 'APPLICATION',
      question: 'Suprakondylär humerusfraktur hos barn med svag radialispuls. Åtgärd?',
      options: [
        { text: 'Akut reposition - pulsen återkommer ofta efter reposition', correct: true },
        { text: 'Observation', correct: false },
        { text: 'Vänta till morgonen', correct: false },
        { text: 'Gips utan reposition', correct: false },
      ],
      explanation: 'Dislocerad suprakondylär fraktur med kärlpåverkan: akut reposition för att återställa cirkulation.',
      reference: 'B-ORTIM Kursbok, Kapitel 17',
    },
    {
      code: '17.8',
      chapterNumber: 17,
      bloomLevel: 'APPLICATION',
      question: 'Patient fastklämd 5 timmar frigörs. Direkt efter friläggning - första risk?',
      options: [
        { text: 'Akut hyperkalemisk hjärtarytmi', correct: true },
        { text: 'Infektion', correct: false },
        { text: 'Fraktur', correct: false },
        { text: 'Hypotermi', correct: false },
      ],
      explanation: 'Vid friläggning frisätts kalium från ischemisk muskel - kan ge fatal arytmi ("rescue death").',
      reference: 'B-ORTIM Kursbok, Kapitel 17',
    },
    {
      code: '17.9',
      chapterNumber: 17,
      bloomLevel: 'APPLICATION',
      question: 'Traumapatient med femurfraktur, lungkontusion, pH 7.2. Strategi?',
      options: [
        { text: 'DCO med extern fixation, optimering på IVA', correct: true },
        { text: 'Direkt märgspikning', correct: false },
        { text: 'Konservativ behandling', correct: false },
        { text: 'Vänta till stabil', correct: false },
      ],
      explanation: 'Multitrauma med acidos: DCO-princip - snabb stabilisering, IVA-optimering, definitiv kirurgi senare.',
      reference: 'B-ORTIM Kursbok, Kapitel 17',
    },
    {
      code: '17.10',
      chapterNumber: 17,
      bloomLevel: 'APPLICATION',
      question: 'Tumamputation hos 5-åring, 3 timmars kall ischemi. Replantation?',
      options: [
        { text: 'Ja - barn har alltid replantationsindikation oavsett finger', correct: true },
        { text: 'Nej - för lång tid', correct: false },
        { text: 'Nej - tumme ej viktig', correct: false },
        { text: 'Beror på föräldrarnas önskemål', correct: false },
      ],
      explanation: 'Pediatriska amputationer har alltid replantationsindikation - barn har utmärkt läknings- och adaptionsförmåga.',
      reference: 'B-ORTIM Kursbok, Kapitel 17',
    },
    {
      code: '17.11',
      chapterNumber: 17,
      bloomLevel: 'APPLICATION',
      question: 'Knäledsluxation reducerad, ABI 0.7. Nästa steg?',
      options: [
        { text: 'CT-angiografi för att utesluta popliteaskada', correct: true },
        { text: 'Observation endast', correct: false },
        { text: 'Gips och hem', correct: false },
        { text: 'Ny röntgen', correct: false },
      ],
      explanation: 'Knäledsluxation har hög risk för popliteaskada. ABI <0.9 kräver angiografi.',
      reference: 'B-ORTIM Kursbok, Kapitel 17',
    },
    {
      code: '17.12',
      chapterNumber: 17,
      bloomLevel: 'ANALYSIS',
      question: 'Vad är viktigast för bra utfall vid extremitetstrauma?',
      options: [
        { text: 'Systematisk approach, tidig identifiering av tidskritiska tillstånd', correct: true },
        { text: 'Snabb röntgen', correct: false },
        { text: 'Avancerad utrustning', correct: false },
        { text: 'Endast kirurgisk kompetens', correct: false },
      ],
      explanation: 'Strukturerad bedömning (cABCDE, LIMB) och snabb identifiering av hot (blödning, ischemi, kompartment) ger bäst utfall.',
      reference: 'B-ORTIM Kursbok, Kapitel 17',
    },
  ];
}
